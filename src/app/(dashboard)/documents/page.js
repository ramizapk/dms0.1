                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-4 mt-4 pt-4 border-t border-slate-100">
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="B">APPROVED AS NOTED</option>
                                    <option value="C">RESUBMIT</option>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <PermissionGate resource="Masar Document" action="create">
                                                        {doc.can_re_submit === 1 && (
                                                            <Link
                                                                href={`/documents/${doc.name}/resubmit`}
                                                                className="h-9 w-9 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center hover:bg-amber-600 hover:text-white transition-all shadow-sm"
                                                                title={t('documents.resubmit') || 'Re-Submit'}
                                                            >
